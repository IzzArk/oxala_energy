import{b as u,g as Y,d as G,e as B,j as e,L as m}from"./app-BXgzW7Ep.js";import{c as X,L as q,X as H,M as J}from"./LOGO-OXALA-C9CdK5i9.js";import{L as K}from"./Oxala-Logo-VTc1k9sF.js";import{s as Q}from"./index--U-sxGBp.js";const Z=(s,n,a,t)=>{const h=[a,{code:n,...t||{}}];if(s?.services?.logger?.forward)return s.services.logger.forward(h,"warn","react-i18next::",!0);y(h[0])&&(h[0]=`react-i18next:: ${h[0]}`),s?.services?.logger?.warn?s.services.logger.warn(...h):console?.warn&&console.warn(...h)},$={},F=(s,n,a,t)=>{y(a)&&$[a]||(y(a)&&($[a]=new Date),Z(s,n,a,t))},T=(s,n)=>()=>{if(s.isInitialized)n();else{const a=()=>{setTimeout(()=>{s.off("initialized",a)},0),n()};s.on("initialized",a)}},I=(s,n,a)=>{s.loadNamespaces(n,T(s,a))},M=(s,n,a,t)=>{if(y(a)&&(a=[a]),s.options.preload&&s.options.preload.indexOf(n)>-1)return I(s,a,t);a.forEach(h=>{s.options.ns.indexOf(h)<0&&s.options.ns.push(h)}),s.loadLanguages(n,T(s,t))},V=(s,n,a={})=>!n.languages||!n.languages.length?(F(n,"NO_LANGUAGES","i18n.languages were undefined or empty",{languages:n.languages}),!0):n.hasLoadedNamespace(s,{lng:a.lng,precheck:(t,h)=>{if(a.bindI18n&&a.bindI18n.indexOf("languageChanging")>-1&&t.services.backendConnector.backend&&t.isLanguageChangingTo&&!h(t.isLanguageChangingTo,s))return!1}}),y=s=>typeof s=="string",ee=s=>typeof s=="object"&&s!==null,ne=u.createContext();class se{constructor(){this.usedNamespaces={}}addUsedNamespaces(n){n.forEach(a=>{this.usedNamespaces[a]||(this.usedNamespaces[a]=!0)})}getUsedNamespaces(){return Object.keys(this.usedNamespaces)}}const re=(s,n)=>{if(y(n))return n;if(ee(n)&&y(n.defaultValue))return n.defaultValue;if(typeof s=="function")return"";if(Array.isArray(s)){const a=s[s.length-1];return typeof a=="function"?"":a}return s},ae={t:re,ready:!1},te=()=>()=>{},P=(s,n={})=>{const{i18n:a}=n,{i18n:t,defaultNS:h}=u.useContext(ne)||{},r=a||t||G();r&&!r.reportNamespaces&&(r.reportNamespaces=new se),r||F(r,"NO_I18NEXT_INSTANCE","useTranslation: You will need to pass in an i18next instance by using initReactI18next or by passing it via props or context. In monorepo setups, make sure there is only one instance of react-i18next.");const x=u.useMemo(()=>({...Y(),...r?.options?.react,...n}),[r,n]),{useSuspense:p,keyPrefix:v}=x,j=s||h||r?.options?.defaultNS,o=y(j)?[j]:j||["translation"],l=u.useMemo(()=>o,o);r?.reportNamespaces?.addUsedNamespaces?.(l);const w=u.useRef(0),k=u.useCallback(c=>{if(!r)return te;const{bindI18n:d,bindI18nStore:i}=x,f=()=>{w.current+=1,c()};return d&&r.on(d,f),i&&r.store.on(i,f),()=>{d&&d.split(" ").forEach(b=>r.off(b,f)),i&&i.split(" ").forEach(b=>r.store.off(b,f))}},[r,x]),g=u.useRef(),R=u.useCallback(()=>{if(!r)return ae;const c=!!(r.isInitialized||r.initializedStoreOnce)&&l.every(W=>V(W,r,x)),d=n.lng||r.language,i=w.current,f=g.current;if(f&&f.ready===c&&f.lng===d&&f.keyPrefix===v&&f.revision===i)return f;const O={t:r.getFixedT(d,x.nsMode==="fallback"?l:l[0],v,{scopeNs:l}),ready:c,lng:d,keyPrefix:v,revision:i};return g.current=O,O},[r,l,v,x,n.lng]),[A,D]=u.useState(0),{t:E,ready:N}=Q.useSyncExternalStore(k,R,R);u.useEffect(()=>{if(r&&!N&&!p){const c=()=>D(d=>d+1);n.lng?M(r,n.lng,l,c):I(r,l,c)}},[r,n.lng,l,N,p,A]);const C=r||{},L=u.useRef(null),_=u.useRef(),z=c=>{const d=Object.getOwnPropertyDescriptors(c);d.__original&&delete d.__original;const i=Object.create(Object.getPrototypeOf(c),d);if(!Object.prototype.hasOwnProperty.call(i,"__original"))try{Object.defineProperty(i,"__original",{value:c,writable:!1,enumerable:!1,configurable:!1})}catch{}return i},U=u.useMemo(()=>{const c=C,d=c?.language;let i=c;c&&(L.current&&L.current.__original===c?_.current!==d?(i=z(c),L.current=i,_.current=d):i=L.current:(i=z(c),L.current=i,_.current=d));const f=!N&&!p?(...O)=>(F(r,"USE_T_BEFORE_READY","useTranslation: t was called before ready. When using useSuspense: false, make sure to check the ready flag before using t."),E(...O)):E,b=[f,i,N];return b.t=f,b.i18n=i,b.ready=N,b},[E,C,N,C.resolvedLanguage,C.language,C.languages]);if(r&&p&&!N){let c=!1;try{c=!1}catch{}throw c&&F(r,"SUSPENDED_WHILE_LOADING","useTranslation: suspended while translations are loading (useSuspense is true by default). Add a <Suspense> boundary above this component, or set react.useSuspense: false in the i18next init options. https://react.i18next.com/latest/usetranslation-hook"),new Promise(d=>{const i=()=>d();n.lng?M(r,n.lng,l,i):I(r,l,i)})}return U};const oe=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],S=X("chevron-down",oe);function me(){const[s,n]=u.useState(!1),{url:a}=B(),t=g=>`
    relative
    transition
    pb-1
    ${a===g?"text-[#23478F] font-semibold":"text-gray-700 hover:text-[#23478F]"}
`,[h,r]=u.useState(!1),[x,p]=u.useState(!1),[v,j]=u.useState(!1),{t:o,i18n:l}=P("common"),[w,k]=u.useState(!1);return e.jsxs("header",{className:"bg-white border-b sticky top-0 z-50",children:[e.jsx("div",{className:"max-w-7xl mx-auto px-6",children:e.jsxs("div",{className:"h-20 flex items-center justify-between",children:[e.jsx(m,{href:"/",children:e.jsx("img",{src:q,alt:"Oxala",className:"h-20"})}),e.jsxs("nav",{className:"hidden lg:flex items-center gap-8 text-[1rem]",children:[e.jsx(m,{href:"/",className:t("/"),children:o("common:navbar.home")}),e.jsxs("div",{className:"relative flex items-center",onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),children:[e.jsx(m,{href:"/tentang-kami",className:t("/tentang-kami"),children:o("common:navbar.about")}),e.jsx("button",{onClick:g=>{g.stopPropagation(),r(!h)},className:"ml-1 p-1",children:e.jsx(S,{size:16,className:`transition ${h?"rotate-180":""}`})}),h&&e.jsxs("div",{className:`\r
                absolute\r
                top-full\r
                left-0\r
                mt-0\r
